...
export default function ScoreTable({whiteTeamName="White", whiteDecode =1, whiteMistake=1, blackTeamName="Black", blackDecode=1, blackMistake=2}: {whiteTeamName: string, whiteDecode: number, whiteMistake: number, blackTeamName: string, blackDecode: number, blackMistake: number}) {
    return (
        <table>
            <tr>
                <th>팀 이름</th>
